          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(" :السورة${widget.chapterData!.ayahs!.length}"),
                Text(" : أسم السورة${widget.chapterData!.number!}"),
                Text(" : وحى${widget.chapterData!.revelationType!}"),
                Text(" :المعنى${widget.chapterData!.englishNameTranslation!}"),
                SizedBox(
                  height: height * 0.02,
                ),
                SizedBox(
